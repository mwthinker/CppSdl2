...
#define SDL_HTML_COLOR(name) HtmlColor{#name, sdl::color::html::name}

		consteval auto getHtmlColors() {
			return std::array{
				SDL_HTML_COLOR(MediumVioletRed),
				SDL_HTML_COLOR(DeepPink),
				SDL_HTML_COLOR(PaleVioletRed),
				SDL_HTML_COLOR(HotPink),
				SDL_HTML_COLOR(LightPink),
				SDL_HTML_COLOR(Pink),
				SDL_HTML_COLOR(DarkRed),
				SDL_HTML_COLOR(Red),
				SDL_HTML_COLOR(Firebrick),
				SDL_HTML_COLOR(Crimson),
				SDL_HTML_COLOR(IndianRed),
				SDL_HTML_COLOR(LightCoral),
				SDL_HTML_COLOR(Salmon),
				SDL_HTML_COLOR(DarkSalmon),
				SDL_HTML_COLOR(LightSalmon),
				SDL_HTML_COLOR(OrangeRed),
				SDL_HTML_COLOR(Tomato),
				SDL_HTML_COLOR(DarkOrange),
				SDL_HTML_COLOR(Coral),
				SDL_HTML_COLOR(Orange),
				SDL_HTML_COLOR(DarkKhaki),
				SDL_HTML_COLOR(Gold),
				SDL_HTML_COLOR(Khaki),
				SDL_HTML_COLOR(PeachPuff),
				SDL_HTML_COLOR(Yellow),
				SDL_HTML_COLOR(PaleGoldenrod),
				SDL_HTML_COLOR(Moccasin),
				SDL_HTML_COLOR(PapayaWhip),
				SDL_HTML_COLOR(LightGoldenrodYellow),
				SDL_HTML_COLOR(LemonChiffon),
				SDL_HTML_COLOR(LightYellow),
				SDL_HTML_COLOR(Maroon),
				SDL_HTML_COLOR(Brown),
				SDL_HTML_COLOR(SaddleBrown),
				SDL_HTML_COLOR(Sienna),
				SDL_HTML_COLOR(Chocolate),
				SDL_HTML_COLOR(DarkGoldenrod),
				SDL_HTML_COLOR(Peru),
				SDL_HTML_COLOR(RosyBrown),
				SDL_HTML_COLOR(Goldenrod),
				SDL_HTML_COLOR(SandyBrown),
				SDL_HTML_COLOR(Tan),
				SDL_HTML_COLOR(Burlywood),
				SDL_HTML_COLOR(Wheat),
				SDL_HTML_COLOR(NavajoWhite),
				SDL_HTML_COLOR(Bisque),
				SDL_HTML_COLOR(BlanchedAlmond),
				SDL_HTML_COLOR(Cornsilk),
				SDL_HTML_COLOR(DarkGreen),
				SDL_HTML_COLOR(Green),
				SDL_HTML_COLOR(DarkOliveGreen),
				SDL_HTML_COLOR(ForestGreen),
				SDL_HTML_COLOR(SeaGreen),
				SDL_HTML_COLOR(Olive),
				SDL_HTML_COLOR(OliveDrab),
				SDL_HTML_COLOR(MediumSeaGreen),
				SDL_HTML_COLOR(LimeGreen),
				SDL_HTML_COLOR(Lime),
				SDL_HTML_COLOR(SpringGreen),
				SDL_HTML_COLOR(MediumSpringGreen),
				SDL_HTML_COLOR(DarkSeaGreen),
				SDL_HTML_COLOR(MediumAquamarine),
				SDL_HTML_COLOR(YellowGreen),
				SDL_HTML_COLOR(LawnGreen),
				SDL_HTML_COLOR(Chartreuse),
				SDL_HTML_COLOR(LightGreen),
				SDL_HTML_COLOR(GreenYellow),
				SDL_HTML_COLOR(PaleGreen),
				SDL_HTML_COLOR(Teal),
				SDL_HTML_COLOR(DarkCyan),
				SDL_HTML_COLOR(LightSeaGreen),
				SDL_HTML_COLOR(CadetBlue),
				SDL_HTML_COLOR(DarkTurquoise),
				SDL_HTML_COLOR(MediumTurquoise),
				SDL_HTML_COLOR(Turquoise),
				SDL_HTML_COLOR(Aqua),
				SDL_HTML_COLOR(Cyan),
				SDL_HTML_COLOR(Aquamarine),
				SDL_HTML_COLOR(PaleTurquoise),
				SDL_HTML_COLOR(LightCyan),
				SDL_HTML_COLOR(Navy),
				SDL_HTML_COLOR(DarkBlue),
				SDL_HTML_COLOR(MediumBlue),
				SDL_HTML_COLOR(Blue),
				SDL_HTML_COLOR(MidnightBlue),
				SDL_HTML_COLOR(RoyalBlue),
				SDL_HTML_COLOR(SteelBlue),
				SDL_HTML_COLOR(DodgerBlue),
				SDL_HTML_COLOR(DeepSkyBlue),
				SDL_HTML_COLOR(CornflowerBlue),
				SDL_HTML_COLOR(SkyBlue),
				SDL_HTML_COLOR(LightSkyBlue),
				SDL_HTML_COLOR(LightSteelBlue),
				SDL_HTML_COLOR(LightBlue),
				SDL_HTML_COLOR(PowderBlue),
				SDL_HTML_COLOR(Indigo),
				SDL_HTML_COLOR(Purple),
				SDL_HTML_COLOR(DarkMagenta),
				SDL_HTML_COLOR(DarkViolet),
				SDL_HTML_COLOR(DarkSlateBlue),
				SDL_HTML_COLOR(BlueViolet),
				SDL_HTML_COLOR(DarkOrchid),
				SDL_HTML_COLOR(Fuchsia),
				SDL_HTML_COLOR(Magenta),
				SDL_HTML_COLOR(SlateBlue),
				SDL_HTML_COLOR(MediumSlateBlue),
				SDL_HTML_COLOR(MediumOrchid),
				SDL_HTML_COLOR(MediumPurple),
				SDL_HTML_COLOR(Orchid),
				SDL_HTML_COLOR(Violet),
				SDL_HTML_COLOR(Plum),
				SDL_HTML_COLOR(Thistle),
				SDL_HTML_COLOR(Lavender),
				SDL_HTML_COLOR(MistyRose),
				SDL_HTML_COLOR(AntiqueWhite),
				SDL_HTML_COLOR(Linen),
				SDL_HTML_COLOR(Beige),
				SDL_HTML_COLOR(WhiteSmoke),
				SDL_HTML_COLOR(LavenderBlush),
				SDL_HTML_COLOR(OldLace),
				SDL_HTML_COLOR(AliceBlue),
				SDL_HTML_COLOR(Seashell),
				SDL_HTML_COLOR(GhostWhite),
				SDL_HTML_COLOR(Honeydew),
				SDL_HTML_COLOR(FloralWhite),
				SDL_HTML_COLOR(Azure),
				SDL_HTML_COLOR(MintCream),
				SDL_HTML_COLOR(Snow),
				SDL_HTML_COLOR(Ivory),
				SDL_HTML_COLOR(White),
				SDL_HTML_COLOR(Black),
				SDL_HTML_COLOR(DarkSlateGray),
				SDL_HTML_COLOR(DimGray),
				SDL_HTML_COLOR(SlateGray),
				SDL_HTML_COLOR(Gray),
				SDL_HTML_COLOR(LightSlateGray),
				SDL_HTML_COLOR(DarkGray),
				SDL_HTML_COLOR(Silver),
				SDL_HTML_COLOR(LightGray),
				SDL_HTML_COLOR(Gainsboro)
			};
		}
	}
